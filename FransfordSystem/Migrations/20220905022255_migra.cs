...
namespace FransfordSystem.Migrations
{
    public partial class migra : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdResultado = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    resultadoExamen = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    idDescripcion = table.Column<int>(type: "int", nullable: false),
                    descripcionidDescripcion = table.Column<int>(type: "int", nullable: true),
                    idReporteExamen = table.Column<int>(type: "int", nullable: false),
                    reporteExamenIdReporteExamen = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Resultado", x => x.IdResultado);
                    table.ForeignKey(
                        name: "FK_Resultado_Descripcion_descripcionidDescripcion",
                        column: x => x.descripcionidDescripcion,
                        principalTable: "Descripcion",
                        principalColumn: "idDescripcion");
                    table.ForeignKey(
                        name: "FK_Resultado_ReporteExamen_reporteExamenIdReporteExamen",
                        column: x => x.reporteExamenIdReporteExamen,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resultado_descripcionidDescripcion",
                table: "Resultado",
                column: "descripcionidDescripcion");

            migrationBuilder.CreateIndex(
                name: "IX_Resultado_reporteExamenIdReporteExamen",
                table: "Resultado",
                column: "reporteExamenIdReporteExamen");
        }
